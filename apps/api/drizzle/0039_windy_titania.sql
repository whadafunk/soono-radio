...
--> statement-breakpoint
INSERT INTO `__new_clock_segments`("id", "clock_id", "sort_order", "name", "type", "duration_seconds", "sources", "start_clip_playlist_id", "end_clip_playlist_id", "bed_playlist_id", "interstitial_jingles_enabled", "jingle_every_n_tracks", "interstitial_station_id_enabled", "station_id_every_n_tracks", "start_policy", "trailing_time", "recovery_tactics", "can_skip", "can_fill", "can_reschedule", "catching_up_order", "coasting_order", "accept_live", "accept_sweepers", "sweeper_config", "silence_detection_action", "silence_threshold_seconds", "rotation_type") SELECT "id", "clock_id", "sort_order", "name", "type", "duration_seconds", "sources", "start_clip_playlist_id", "end_clip_playlist_id", "bed_playlist_id", "interstitial_jingles_enabled", "jingle_every_n_tracks", "interstitial_station_id_enabled", "station_id_every_n_tracks", "start_policy", "trailing_time", "recovery_tactics", "can_skip", "can_fill", "can_reschedule", "catching_up_order", "coasting_order", "accept_live", "accept_sweepers", "sweeper_config", "silence_detection_action", "silence_threshold_seconds", "rotation_type" FROM `clock_segments`;--> statement-breakpoint
